...
def main():
    ...
    for i in range(6):
        print("BAR", i, dev.pcie_cfg_req(0x10 + 4 * i, bus=1, dev=0, fn=0, cfgreq_type=1, value=None, size=4))
    ...
    for bus in range(1, 32):
        for fn in range(0, 8):
            try:
                print(hex(dev.pcie_cfg_req(0, bus=bus, dev=0, fn=fn, cfgreq_type=1, value=None, size=2)))
            except: pass

    print(hex(dev.pcie_cfg_req(2, bus=3, dev=0, fn=fn, cfgreq_type=1, value=None, size=2)))
