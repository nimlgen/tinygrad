#!/usr/bin/env python3
import socket, struct, sys, pickle, signal
...
def handle(conn, cmd, dev_id, bar, arg0, arg1, arg2):
  ...
  if cmd == RemoteCmd.MAP_BAR:
    ...
    memview, paddrs = pci_dev.alloc_sysmem(arg0, vaddr=arg2, contiguous=bool(arg1))
    ...
    programs.append(Device["CPU"].runtime(pickle.loads(conn.recv(arg0, socket.MSG_WAITALL))))
