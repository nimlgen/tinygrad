...
from tinygrad.runtime.support.bnxt import BNXT_CHIMP_COMM, BNXT_CHIMP_COMM_TRIGGER, BNXTDev
...
class TestHWRM(unittest.TestCase):
  def setUp(self):
    self.barrier = patch("tinygrad.runtime.support.bnxt.System.memory_barrier").start()
