...
renderer = functools.partial(uops_to_cstyle, CStyleLanguage(
  ...
  half_prekernel = """
    ...
    """))
CUDABuffer = Compiled(RawCUDABuffer, LinearizerOptions(supports_float4=True, supports_float4_alu=False, global_max = [65535, 65535, 2147483647], local_max = [64, 1024, 1024], device="CUDA"), renderer, CUDAProgram, cuda.Context.synchronize)
