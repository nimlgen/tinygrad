...
from tinygrad.device import Compiler, CompileError, BufferOptions, HCQCompatAllocator, HCQCompatComiled
from tinygrad.helpers import getenv, from_mv, init_c_struct_t, to_mv, round_up, to_char_p_p, DEBUG, prod, mv_address
...
class NVDevice(HCQCompatComiled):
  root = None
  fd_ctl: int = -1
  fd_uvm: int = -1
  gpus_info = None
