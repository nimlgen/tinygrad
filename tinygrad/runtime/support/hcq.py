...
class HCQCompiled(Compiled, Generic[SignalType]):
  ...
  def __init__(self, device:str, allocator:HCQAllocatorBase, compilers:list[type[Renderer]|functools.partial], runtime,
               signal_t:Type[SignalType]|None=None, comp_queue_t:Callable[..., HWQueue]|None=None, copy_queue_t:Callable[..., HWQueue]|None=None,
               kernargs_size=(16 << 20), sigalloc_size=0x1000, can_recover:bool=False):
