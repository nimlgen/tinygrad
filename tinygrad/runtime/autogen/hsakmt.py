...
# -*- coding: utf-8 -*-
#
# TARGET arch is: ['-I/opt/rocm/include', '-I/opt/rocm/include', '-x', 'c++']
# WORD_SIZE is: 8
# POINTER_SIZE is: 8
...
_libraries = {}
_libraries['libhsakmt.so'] = ctypes.CDLL('/home/nimlgen/amd/hipruntime-03072024/lib/libhsakmt.so')
...
class struct__hsakmttypes_h_165(Structure):
    pass

struct__hsakmttypes_h_165._pack_ = 1 # source:False
struct__hsakmttypes_h_165._fields_ = [
...
union_HSA_ENGINE_ID._fields_ = [
    ...
    ('ui32', struct__hsakmttypes_h_165),
]
...
class struct__hsakmttypes_h_177(Structure):
    pass

struct__hsakmttypes_h_177._pack_ = 1 # source:False
struct__hsakmttypes_h_177._fields_ = [
...
class struct__hsakmttypes_h_188(Structure):
    pass

struct__hsakmttypes_h_188._pack_ = 1 # source:False
struct__hsakmttypes_h_188._fields_ = [
...
union_HSA_CAPABILITY._fields_ = [
    ('Value', ctypes.c_uint32),
    ('ui32', struct__hsakmttypes_h_188),
]
...
class struct__hsakmttypes_h_229(Structure):
    pass

struct__hsakmttypes_h_229._pack_ = 1 # source:False
struct__hsakmttypes_h_229._fields_ = [
...
class struct__hsakmttypes_h_359(Structure):
    pass

struct__hsakmttypes_h_359._pack_ = 1 # source:False
struct__hsakmttypes_h_359._fields_ = [
    ('HotPluggable', ctypes.c_uint32, 1),
...
union_HSA_MEMORYPROPERTY._fields_ = [
    ...
    ('ui32', struct__hsakmttypes_h_359),
]
...
class union__hsakmttypes_h_377(Union):
    pass

class struct__hsakmttypes_h_380(Structure):
    pass

struct__hsakmttypes_h_380._pack_ = 1 # source:False
struct__hsakmttypes_h_380._fields_ = [
    ('SizeInBytesLow', ctypes.c_uint32),
    ('SizeInBytesHigh', ctypes.c_uint32),
]

union__hsakmttypes_h_377._pack_ = 1 # source:False
union__hsakmttypes_h_377._fields_ = [
    ('SizeInBytes', ctypes.c_uint64),
    ('ui32', struct__hsakmttypes_h_380),
]
...
class struct__hsakmttypes_h_407(Structure):
    pass

struct__hsakmttypes_h_407._pack_ = 1 # source:False
struct__hsakmttypes_h_407._fields_ = [
...
union_HsaCacheType._fields_ = [
    ('Value', ctypes.c_uint32),
    ('ui32', struct__hsakmttypes_h_407),
]
...
class struct__hsakmttypes_h_474(Structure):
    pass

struct__hsakmttypes_h_474._pack_ = 1 # source:False
struct__hsakmttypes_h_474._fields_ = [
...
union_HSA_LINKPROPERTY._fields_ = [
    ...
    ('ui32', struct__hsakmttypes_h_474),
]
...
class union__hsakmttypes_h_514(Union):
    pass

class struct__hsakmttypes_h_516(Structure):
    pass

struct__hsakmttypes_h_516._pack_ = 1 # source:False
struct__hsakmttypes_h_516._fields_ = [
...
union__hsakmttypes_h_514._pack_ = 1 # source:False
union__hsakmttypes_h_514._fields_ = [
    ('ui32', struct__hsakmttypes_h_516),
    ('Value', ctypes.c_uint32),
]
...
class union__hsakmttypes_h_579(Union):
    pass

class struct__hsakmttypes_h_581(Structure):
    pass

struct__hsakmttypes_h_581._pack_ = 1 # source:False
struct__hsakmttypes_h_581._fields_ = [
...
union__hsakmttypes_h_579._pack_ = 1 # source:False
union__hsakmttypes_h_579._fields_ = [
    ('ui32', struct__hsakmttypes_h_581),
    ('Value', ctypes.c_uint32),
]
...
class union__hsakmttypes_h_743(Union):
    pass

union__hsakmttypes_h_743._pack_ = 1 # source:False
union__hsakmttypes_h_743._fields_ = [
...
class union__hsakmttypes_h_751(Union):
    pass

union__hsakmttypes_h_751._pack_ = 1 # source:False
union__hsakmttypes_h_751._fields_ = [
...
class union__hsakmttypes_h_759(Union):
    pass

union__hsakmttypes_h_759._pack_ = 1 # source:False
union__hsakmttypes_h_759._fields_ = [
...
struct__HsaQueueResource._fields_ = [
    ...
    ('_0', union__hsakmttypes_h_743),
    ('_1', union__hsakmttypes_h_751),
    ('_2', union__hsakmttypes_h_759),
    ('ErrorReason', ctypes.POINTER(ctypes.c_int64)),
]
...
class union__hsakmttypes_h_972(Union):
    pass

union__hsakmttypes_h_972._pack_ = 1 # source:False
union__hsakmttypes_h_972._fields_ = [
...
struct__HsaSyncVar._fields_ = [
    ('SyncVar', union__hsakmttypes_h_972),
...
class union__hsakmttypes_h_1066(Union):
    pass

union__hsakmttypes_h_1066._pack_ = 1 # source:False
union__hsakmttypes_h_1066._fields_ = [
    ('SyncVar', HsaSyncVar),
...
struct__HsaEventData._fields_ = [
    ...
    ('EventData', union__hsakmttypes_h_1066),
...
class union__hsakmttypes_h_1277(Union):
    pass

class struct__hsakmttypes_h_1279(Structure):
    pass

struct__hsakmttypes_h_1279._pack_ = 1 # source:False
struct__hsakmttypes_h_1279._fields_ = [
...
union__hsakmttypes_h_1277._pack_ = 1 # source:False
union__hsakmttypes_h_1277._fields_ = [
    ('ui32', struct__hsakmttypes_h_1279),
    ('Value', ctypes.c_uint32),
]
...
class union__sdma_registers_h_70(Union):
    pass

class struct__sdma_registers_h_71(Structure):
    pass

struct__sdma_registers_h_71._pack_ = 1 # source:False
struct__sdma_registers_h_71._fields_ = [
    ('op', ctypes.c_uint32, 8),
    ('sub_op', ctypes.c_uint32, 8),
    ('extra_info', ctypes.c_uint32, 16),
]

union__sdma_registers_h_70._pack_ = 1 # source:False
union__sdma_registers_h_70._anonymous_ = ('_0',)
union__sdma_registers_h_70._fields_ = [
    ('_0', struct__sdma_registers_h_71),
    ('DW_0_DATA', ctypes.c_uint32),
]

class union__sdma_registers_h_79(Union):
    pass

class struct__sdma_registers_h_80(Structure):
    pass

struct__sdma_registers_h_80._pack_ = 1 # source:False
struct__sdma_registers_h_80._fields_ = [
    ('count', ctypes.c_uint32, 22),
    ('reserved_0', ctypes.c_uint32, 10),
]

union__sdma_registers_h_79._pack_ = 1 # source:False
union__sdma_registers_h_79._anonymous_ = ('_0',)
union__sdma_registers_h_79._fields_ = [
    ('_0', struct__sdma_registers_h_80),
    ('DW_1_DATA', ctypes.c_uint32),
]

class union__sdma_registers_h_87(Union):
    pass

class struct__sdma_registers_h_88(Structure):
    pass

struct__sdma_registers_h_88._pack_ = 1 # source:False
struct__sdma_registers_h_88._fields_ = [
...
union__sdma_registers_h_87._pack_ = 1 # source:False
union__sdma_registers_h_87._anonymous_ = ('_0',)
union__sdma_registers_h_87._fields_ = [
    ('_0', struct__sdma_registers_h_88),
    ('DW_2_DATA', ctypes.c_uint32),
]

class union__sdma_registers_h_98(Union):
    pass

class struct__sdma_registers_h_99(Structure):
    pass

struct__sdma_registers_h_99._pack_ = 1 # source:False
struct__sdma_registers_h_99._fields_ = [
    ('src_addr_31_0', ctypes.c_uint32, 32),
]

union__sdma_registers_h_98._pack_ = 1 # source:False
union__sdma_registers_h_98._anonymous_ = ('_0',)
union__sdma_registers_h_98._fields_ = [
    ('_0', struct__sdma_registers_h_99),
    ('DW_3_DATA', ctypes.c_uint32),
]

class union__sdma_registers_h_105(Union):
    pass

class struct__sdma_registers_h_106(Structure):
    pass

struct__sdma_registers_h_106._pack_ = 1 # source:False
struct__sdma_registers_h_106._fields_ = [
    ('src_addr_63_32', ctypes.c_uint32, 32),
]

union__sdma_registers_h_105._pack_ = 1 # source:False
union__sdma_registers_h_105._anonymous_ = ('_0',)
union__sdma_registers_h_105._fields_ = [
    ('_0', struct__sdma_registers_h_106),
    ('DW_4_DATA', ctypes.c_uint32),
]

class union__sdma_registers_h_112(Union):
    pass

class struct__sdma_registers_h_113(Structure):
    pass

struct__sdma_registers_h_113._pack_ = 1 # source:False
struct__sdma_registers_h_113._fields_ = [
    ('dst_addr_31_0', ctypes.c_uint32, 32),
]

union__sdma_registers_h_112._pack_ = 1 # source:False
union__sdma_registers_h_112._anonymous_ = ('_0',)
union__sdma_registers_h_112._fields_ = [
    ('_0', struct__sdma_registers_h_113),
    ('DW_5_DATA', ctypes.c_uint32),
]

class union__sdma_registers_h_119(Union):
    pass

class struct__sdma_registers_h_120(Structure):
    pass

struct__sdma_registers_h_120._pack_ = 1 # source:False
struct__sdma_registers_h_120._fields_ = [
    ('dst_addr_63_32', ctypes.c_uint32, 32),
]

union__sdma_registers_h_119._pack_ = 1 # source:False
union__sdma_registers_h_119._anonymous_ = ('_0',)
union__sdma_registers_h_119._fields_ = [
    ('_0', struct__sdma_registers_h_120),
    ('DW_6_DATA', ctypes.c_uint32),
]

struct_SDMA_PKT_COPY_LINEAR_TAG._pack_ = 1 # source:False
struct_SDMA_PKT_COPY_LINEAR_TAG._fields_ = [
    ('HEADER_UNION', union__sdma_registers_h_70),
    ('COUNT_UNION', union__sdma_registers_h_79),
    ('PARAMETER_UNION', union__sdma_registers_h_87),
    ('SRC_ADDR_LO_UNION', union__sdma_registers_h_98),
    ('SRC_ADDR_HI_UNION', union__sdma_registers_h_105),
    ('DST_ADDR_LO_UNION', union__sdma_registers_h_112),
    ('DST_ADDR_HI_UNION', union__sdma_registers_h_119),
]
...
class union__sdma_registers_h_136(Union):
    pass

class struct__sdma_registers_h_137(Structure):
    pass

struct__sdma_registers_h_137._pack_ = 1 # source:False
struct__sdma_registers_h_137._fields_ = [
    ('op', ctypes.c_uint32, 8),
    ('sub_op', ctypes.c_uint32, 8),
...
union__sdma_registers_h_136._pack_ = 1 # source:False
union__sdma_registers_h_136._anonymous_ = ('_0',)
union__sdma_registers_h_136._fields_ = [
    ('_0', struct__sdma_registers_h_137),
    ('DW_0_DATA', ctypes.c_uint32),
]

class union__sdma_registers_h_146(Union):
    pass

class struct__sdma_registers_h_147(Structure):
    pass

struct__sdma_registers_h_147._pack_ = 1 # source:False
struct__sdma_registers_h_147._fields_ = [
    ('src_addr_31_0', ctypes.c_uint32, 32),
]

union__sdma_registers_h_146._pack_ = 1 # source:False
union__sdma_registers_h_146._anonymous_ = ('_0',)
union__sdma_registers_h_146._fields_ = [
    ('_0', struct__sdma_registers_h_147),
    ('DW_1_DATA', ctypes.c_uint32),
]

class union__sdma_registers_h_153(Union):
    pass

class struct__sdma_registers_h_154(Structure):
    pass

struct__sdma_registers_h_154._pack_ = 1 # source:False
struct__sdma_registers_h_154._fields_ = [
    ('src_addr_63_32', ctypes.c_uint32, 32),
]

union__sdma_registers_h_153._pack_ = 1 # source:False
union__sdma_registers_h_153._anonymous_ = ('_0',)
union__sdma_registers_h_153._fields_ = [
    ('_0', struct__sdma_registers_h_154),
    ('DW_2_DATA', ctypes.c_uint32),
]

class union__sdma_registers_h_160(Union):
    pass

class struct__sdma_registers_h_161(Structure):
    pass

struct__sdma_registers_h_161._pack_ = 1 # source:False
struct__sdma_registers_h_161._fields_ = [
...
union__sdma_registers_h_160._pack_ = 1 # source:False
union__sdma_registers_h_160._anonymous_ = ('_0',)
union__sdma_registers_h_160._fields_ = [
    ('_0', struct__sdma_registers_h_161),
    ('DW_3_DATA', ctypes.c_uint32),
]

class union__sdma_registers_h_170(Union):
    pass

class struct__sdma_registers_h_171(Structure):
    pass

struct__sdma_registers_h_171._pack_ = 1 # source:False
struct__sdma_registers_h_171._fields_ = [
    ('src_offset_z', ctypes.c_uint32, 11),
    ('reserved_1', ctypes.c_uint32, 2),
    ('src_pitch', ctypes.c_uint32, 19),
]

union__sdma_registers_h_170._pack_ = 1 # source:False
union__sdma_registers_h_170._anonymous_ = ('_0',)
union__sdma_registers_h_170._fields_ = [
    ('_0', struct__sdma_registers_h_171),
    ('DW_4_DATA', ctypes.c_uint32),
]

class union__sdma_registers_h_179(Union):
    pass

class struct__sdma_registers_h_180(Structure):
    pass

struct__sdma_registers_h_180._pack_ = 1 # source:False
struct__sdma_registers_h_180._fields_ = [
    ('src_slice_pitch', ctypes.c_uint32, 28),
    ('reserved_1', ctypes.c_uint32, 4),
]

union__sdma_registers_h_179._pack_ = 1 # source:False
union__sdma_registers_h_179._anonymous_ = ('_0',)
union__sdma_registers_h_179._fields_ = [
    ('_0', struct__sdma_registers_h_180),
    ('DW_5_DATA', ctypes.c_uint32),
]

class union__sdma_registers_h_187(Union):
    pass

class struct__sdma_registers_h_188(Structure):
    pass

struct__sdma_registers_h_188._pack_ = 1 # source:False
struct__sdma_registers_h_188._fields_ = [
    ('dst_addr_31_0', ctypes.c_uint32, 32),
]

union__sdma_registers_h_187._pack_ = 1 # source:False
union__sdma_registers_h_187._anonymous_ = ('_0',)
union__sdma_registers_h_187._fields_ = [
    ('_0', struct__sdma_registers_h_188),
    ('DW_6_DATA', ctypes.c_uint32),
]

class union__sdma_registers_h_194(Union):
    pass

class struct__sdma_registers_h_195(Structure):
    pass

struct__sdma_registers_h_195._pack_ = 1 # source:False
struct__sdma_registers_h_195._fields_ = [
    ('dst_addr_63_32', ctypes.c_uint32, 32),
]

union__sdma_registers_h_194._pack_ = 1 # source:False
union__sdma_registers_h_194._anonymous_ = ('_0',)
union__sdma_registers_h_194._fields_ = [
    ('_0', struct__sdma_registers_h_195),
    ('DW_7_DATA', ctypes.c_uint32),
]

class union__sdma_registers_h_201(Union):
    pass

class struct__sdma_registers_h_202(Structure):
    pass

struct__sdma_registers_h_202._pack_ = 1 # source:False
struct__sdma_registers_h_202._fields_ = [
...
union__sdma_registers_h_201._pack_ = 1 # source:False
union__sdma_registers_h_201._anonymous_ = ('_0',)
union__sdma_registers_h_201._fields_ = [
    ('_0', struct__sdma_registers_h_202),
    ('DW_8_DATA', ctypes.c_uint32),
]

class union__sdma_registers_h_211(Union):
    pass

class struct__sdma_registers_h_212(Structure):
    pass

struct__sdma_registers_h_212._pack_ = 1 # source:False
struct__sdma_registers_h_212._fields_ = [
    ('dst_offset_z', ctypes.c_uint32, 11),
    ('reserved_1', ctypes.c_uint32, 2),
    ('dst_pitch', ctypes.c_uint32, 19),
]

union__sdma_registers_h_211._pack_ = 1 # source:False
union__sdma_registers_h_211._anonymous_ = ('_0',)
union__sdma_registers_h_211._fields_ = [
    ('_0', struct__sdma_registers_h_212),
    ('DW_9_DATA', ctypes.c_uint32),
]

class union__sdma_registers_h_220(Union):
    pass

class struct__sdma_registers_h_221(Structure):
    pass

struct__sdma_registers_h_221._pack_ = 1 # source:False
struct__sdma_registers_h_221._fields_ = [
    ('dst_slice_pitch', ctypes.c_uint32, 28),
    ('reserved_1', ctypes.c_uint32, 4),
]

union__sdma_registers_h_220._pack_ = 1 # source:False
union__sdma_registers_h_220._anonymous_ = ('_0',)
union__sdma_registers_h_220._fields_ = [
    ('_0', struct__sdma_registers_h_221),
    ('DW_10_DATA', ctypes.c_uint32),
]

class union__sdma_registers_h_228(Union):
    pass

class struct__sdma_registers_h_229(Structure):
    pass

struct__sdma_registers_h_229._pack_ = 1 # source:False
struct__sdma_registers_h_229._fields_ = [
...
union__sdma_registers_h_228._pack_ = 1 # source:False
union__sdma_registers_h_228._anonymous_ = ('_0',)
union__sdma_registers_h_228._fields_ = [
    ('_0', struct__sdma_registers_h_229),
    ('DW_11_DATA', ctypes.c_uint32),
]

class union__sdma_registers_h_238(Union):
    pass

class struct__sdma_registers_h_239(Structure):
    pass

struct__sdma_registers_h_239._pack_ = 1 # source:False
struct__sdma_registers_h_239._fields_ = [
...
union__sdma_registers_h_238._pack_ = 1 # source:False
union__sdma_registers_h_238._anonymous_ = ('_0',)
union__sdma_registers_h_238._fields_ = [
    ('_0', struct__sdma_registers_h_239),
...
struct_SDMA_PKT_COPY_LINEAR_RECT_TAG._fields_ = [
    ('HEADER_UNION', union__sdma_registers_h_136),
    ('SRC_ADDR_LO_UNION', union__sdma_registers_h_146),
    ('SRC_ADDR_HI_UNION', union__sdma_registers_h_153),
    ('SRC_PARAMETER_1_UNION', union__sdma_registers_h_160),
    ('SRC_PARAMETER_2_UNION', union__sdma_registers_h_170),
    ('SRC_PARAMETER_3_UNION', union__sdma_registers_h_179),
    ('DST_ADDR_LO_UNION', union__sdma_registers_h_187),
    ('DST_ADDR_HI_UNION', union__sdma_registers_h_194),
    ('DST_PARAMETER_1_UNION', union__sdma_registers_h_201),
    ('DST_PARAMETER_2_UNION', union__sdma_registers_h_211),
    ('DST_PARAMETER_3_UNION', union__sdma_registers_h_220),
    ('RECT_PARAMETER_1_UNION', union__sdma_registers_h_228),
    ('RECT_PARAMETER_2_UNION', union__sdma_registers_h_238),
]
...
class union__sdma_registers_h_253(Union):
    pass

class struct__sdma_registers_h_254(Structure):
    pass

struct__sdma_registers_h_254._pack_ = 1 # source:False
struct__sdma_registers_h_254._fields_ = [
    ('op', ctypes.c_uint32, 8),
    ('sub_op', ctypes.c_uint32, 8),
...
union__sdma_registers_h_253._pack_ = 1 # source:False
union__sdma_registers_h_253._anonymous_ = ('_0',)
union__sdma_registers_h_253._fields_ = [
    ('_0', struct__sdma_registers_h_254),
    ('DW_0_DATA', ctypes.c_uint32),
]

class union__sdma_registers_h_264(Union):
    pass

class struct__sdma_registers_h_265(Structure):
    pass

struct__sdma_registers_h_265._pack_ = 1 # source:False
struct__sdma_registers_h_265._fields_ = [
    ('dst_addr_31_0', ctypes.c_uint32, 32),
]

union__sdma_registers_h_264._pack_ = 1 # source:False
union__sdma_registers_h_264._anonymous_ = ('_0',)
union__sdma_registers_h_264._fields_ = [
    ('_0', struct__sdma_registers_h_265),
    ('DW_1_DATA', ctypes.c_uint32),
]

class union__sdma_registers_h_271(Union):
    pass

class struct__sdma_registers_h_272(Structure):
    pass

struct__sdma_registers_h_272._pack_ = 1 # source:False
struct__sdma_registers_h_272._fields_ = [
    ('dst_addr_63_32', ctypes.c_uint32, 32),
]

union__sdma_registers_h_271._pack_ = 1 # source:False
union__sdma_registers_h_271._anonymous_ = ('_0',)
union__sdma_registers_h_271._fields_ = [
    ('_0', struct__sdma_registers_h_272),
    ('DW_2_DATA', ctypes.c_uint32),
]

class union__sdma_registers_h_278(Union):
    pass

class struct__sdma_registers_h_279(Structure):
    pass

struct__sdma_registers_h_279._pack_ = 1 # source:False
struct__sdma_registers_h_279._fields_ = [
    ('src_data_31_0', ctypes.c_uint32, 32),
]

union__sdma_registers_h_278._pack_ = 1 # source:False
union__sdma_registers_h_278._anonymous_ = ('_0',)
union__sdma_registers_h_278._fields_ = [
    ('_0', struct__sdma_registers_h_279),
    ('DW_3_DATA', ctypes.c_uint32),
]

class union__sdma_registers_h_285(Union):
    pass

class struct__sdma_registers_h_286(Structure):
    pass

struct__sdma_registers_h_286._pack_ = 1 # source:False
struct__sdma_registers_h_286._fields_ = [
    ('count', ctypes.c_uint32, 22),
    ('reserved_0', ctypes.c_uint32, 10),
]

union__sdma_registers_h_285._pack_ = 1 # source:False
union__sdma_registers_h_285._anonymous_ = ('_0',)
union__sdma_registers_h_285._fields_ = [
    ('_0', struct__sdma_registers_h_286),
    ('DW_4_DATA', ctypes.c_uint32),
]

struct_SDMA_PKT_CONSTANT_FILL_TAG._pack_ = 1 # source:False
struct_SDMA_PKT_CONSTANT_FILL_TAG._fields_ = [
    ('HEADER_UNION', union__sdma_registers_h_253),
    ('DST_ADDR_LO_UNION', union__sdma_registers_h_264),
    ('DST_ADDR_HI_UNION', union__sdma_registers_h_271),
    ('DATA_UNION', union__sdma_registers_h_278),
    ('COUNT_UNION', union__sdma_registers_h_285),
]
...
class union__sdma_registers_h_297(Union):
    pass

class struct__sdma_registers_h_298(Structure):
    pass

struct__sdma_registers_h_298._pack_ = 1 # source:False
struct__sdma_registers_h_298._fields_ = [
    ('op', ctypes.c_uint32, 8),
    ('sub_op', ctypes.c_uint32, 8),
...
union__sdma_registers_h_297._pack_ = 1 # source:False
union__sdma_registers_h_297._anonymous_ = ('_0',)
union__sdma_registers_h_297._fields_ = [
    ('_0', struct__sdma_registers_h_298),
    ('DW_0_DATA', ctypes.c_uint32),
]

class union__sdma_registers_h_313(Union):
    pass

class struct__sdma_registers_h_314(Structure):
    pass

struct__sdma_registers_h_314._pack_ = 1 # source:False
struct__sdma_registers_h_314._fields_ = [
    ('addr_31_0', ctypes.c_uint32, 32),
]

union__sdma_registers_h_313._pack_ = 1 # source:False
union__sdma_registers_h_313._anonymous_ = ('_0',)
union__sdma_registers_h_313._fields_ = [
    ('_0', struct__sdma_registers_h_314),
    ('DW_1_DATA', ctypes.c_uint32),
]

class union__sdma_registers_h_320(Union):
    pass

class struct__sdma_registers_h_321(Structure):
    pass

struct__sdma_registers_h_321._pack_ = 1 # source:False
struct__sdma_registers_h_321._fields_ = [
    ('addr_63_32', ctypes.c_uint32, 32),
]

union__sdma_registers_h_320._pack_ = 1 # source:False
union__sdma_registers_h_320._anonymous_ = ('_0',)
union__sdma_registers_h_320._fields_ = [
    ('_0', struct__sdma_registers_h_321),
    ('DW_2_DATA', ctypes.c_uint32),
]

class union__sdma_registers_h_327(Union):
    pass

class struct__sdma_registers_h_328(Structure):
    pass

struct__sdma_registers_h_328._pack_ = 1 # source:False
struct__sdma_registers_h_328._fields_ = [
    ('data', ctypes.c_uint32, 32),
]

union__sdma_registers_h_327._pack_ = 1 # source:False
union__sdma_registers_h_327._anonymous_ = ('_0',)
union__sdma_registers_h_327._fields_ = [
    ('_0', struct__sdma_registers_h_328),
    ('DW_3_DATA', ctypes.c_uint32),
]

struct_SDMA_PKT_FENCE_TAG._pack_ = 1 # source:False
struct_SDMA_PKT_FENCE_TAG._fields_ = [
    ('HEADER_UNION', union__sdma_registers_h_297),
    ('ADDR_LO_UNION', union__sdma_registers_h_313),
    ('ADDR_HI_UNION', union__sdma_registers_h_320),
    ('DATA_UNION', union__sdma_registers_h_327),
]
...
class union__sdma_registers_h_336(Union):
    pass

class struct__sdma_registers_h_337(Structure):
    pass

struct__sdma_registers_h_337._pack_ = 1 # source:False
struct__sdma_registers_h_337._fields_ = [
    ('op', ctypes.c_uint32, 8),
    ('sub_op', ctypes.c_uint32, 8),
    ('reserved_0', ctypes.c_uint32, 10),
...
union__sdma_registers_h_336._pack_ = 1 # source:False
union__sdma_registers_h_336._anonymous_ = ('_0',)
union__sdma_registers_h_336._fields_ = [
    ('_0', struct__sdma_registers_h_337),
    ('DW_0_DATA', ctypes.c_uint32),
]

class union__sdma_registers_h_349(Union):
    pass

class struct__sdma_registers_h_350(Structure):
    pass

struct__sdma_registers_h_350._pack_ = 1 # source:False
struct__sdma_registers_h_350._fields_ = [
    ('addr_31_0', ctypes.c_uint32, 32),
]

union__sdma_registers_h_349._pack_ = 1 # source:False
union__sdma_registers_h_349._anonymous_ = ('_0',)
union__sdma_registers_h_349._fields_ = [
    ('_0', struct__sdma_registers_h_350),
    ('DW_1_DATA', ctypes.c_uint32),
]

class union__sdma_registers_h_356(Union):
    pass

class struct__sdma_registers_h_357(Structure):
    pass

struct__sdma_registers_h_357._pack_ = 1 # source:False
struct__sdma_registers_h_357._fields_ = [
    ('addr_63_32', ctypes.c_uint32, 32),
]

union__sdma_registers_h_356._pack_ = 1 # source:False
union__sdma_registers_h_356._anonymous_ = ('_0',)
union__sdma_registers_h_356._fields_ = [
    ('_0', struct__sdma_registers_h_357),
    ('DW_2_DATA', ctypes.c_uint32),
]

class union__sdma_registers_h_363(Union):
    pass

class struct__sdma_registers_h_364(Structure):
    pass

struct__sdma_registers_h_364._pack_ = 1 # source:False
struct__sdma_registers_h_364._fields_ = [
    ('value', ctypes.c_uint32, 32),
]

union__sdma_registers_h_363._pack_ = 1 # source:False
union__sdma_registers_h_363._anonymous_ = ('_0',)
union__sdma_registers_h_363._fields_ = [
    ('_0', struct__sdma_registers_h_364),
    ('DW_3_DATA', ctypes.c_uint32),
]

class union__sdma_registers_h_370(Union):
    pass

class struct__sdma_registers_h_371(Structure):
    pass

struct__sdma_registers_h_371._pack_ = 1 # source:False
struct__sdma_registers_h_371._fields_ = [
    ('mask', ctypes.c_uint32, 32),
]

union__sdma_registers_h_370._pack_ = 1 # source:False
union__sdma_registers_h_370._anonymous_ = ('_0',)
union__sdma_registers_h_370._fields_ = [
    ('_0', struct__sdma_registers_h_371),
    ('DW_4_DATA', ctypes.c_uint32),
]

class union__sdma_registers_h_377(Union):
    pass

class struct__sdma_registers_h_378(Structure):
    pass

struct__sdma_registers_h_378._pack_ = 1 # source:False
struct__sdma_registers_h_378._fields_ = [
    ('interval', ctypes.c_uint32, 16),
    ('retry_count', ctypes.c_uint32, 12),
    ('reserved_0', ctypes.c_uint32, 4),
]

union__sdma_registers_h_377._pack_ = 1 # source:False
union__sdma_registers_h_377._anonymous_ = ('_0',)
union__sdma_registers_h_377._fields_ = [
    ('_0', struct__sdma_registers_h_378),
    ('DW_5_DATA', ctypes.c_uint32),
]

struct_SDMA_PKT_POLL_REGMEM_TAG._pack_ = 1 # source:False
struct_SDMA_PKT_POLL_REGMEM_TAG._fields_ = [
    ('HEADER_UNION', union__sdma_registers_h_336),
    ('ADDR_LO_UNION', union__sdma_registers_h_349),
    ('ADDR_HI_UNION', union__sdma_registers_h_356),
    ('VALUE_UNION', union__sdma_registers_h_363),
    ('MASK_UNION', union__sdma_registers_h_370),
    ('DW5_UNION', union__sdma_registers_h_377),
]
...
class union__sdma_registers_h_388(Union):
    pass

class struct__sdma_registers_h_389(Structure):
    pass

struct__sdma_registers_h_389._pack_ = 1 # source:False
struct__sdma_registers_h_389._fields_ = [
    ('op', ctypes.c_uint32, 8),
    ('sub_op', ctypes.c_uint32, 8),
    ('l', ctypes.c_uint32, 1),
...
union__sdma_registers_h_388._pack_ = 1 # source:False
union__sdma_registers_h_388._anonymous_ = ('_0',)
union__sdma_registers_h_388._fields_ = [
    ('_0', struct__sdma_registers_h_389),
    ('DW_0_DATA', ctypes.c_uint32),
]

class union__sdma_registers_h_399(Union):
    pass

class struct__sdma_registers_h_400(Structure):
    pass

struct__sdma_registers_h_400._pack_ = 1 # source:False
struct__sdma_registers_h_400._fields_ = [
    ('addr_31_0', ctypes.c_uint32, 32),
]

union__sdma_registers_h_399._pack_ = 1 # source:False
union__sdma_registers_h_399._anonymous_ = ('_0',)
union__sdma_registers_h_399._fields_ = [
    ('_0', struct__sdma_registers_h_400),
    ('DW_1_DATA', ctypes.c_uint32),
]

class union__sdma_registers_h_406(Union):
    pass

class struct__sdma_registers_h_407(Structure):
    pass

struct__sdma_registers_h_407._pack_ = 1 # source:False
struct__sdma_registers_h_407._fields_ = [
    ('addr_63_32', ctypes.c_uint32, 32),
]

union__sdma_registers_h_406._pack_ = 1 # source:False
union__sdma_registers_h_406._anonymous_ = ('_0',)
union__sdma_registers_h_406._fields_ = [
    ('_0', struct__sdma_registers_h_407),
    ('DW_2_DATA', ctypes.c_uint32),
]

class union__sdma_registers_h_413(Union):
    pass

class struct__sdma_registers_h_414(Structure):
    pass

struct__sdma_registers_h_414._pack_ = 1 # source:False
struct__sdma_registers_h_414._fields_ = [
    ('src_data_31_0', ctypes.c_uint32, 32),
]

union__sdma_registers_h_413._pack_ = 1 # source:False
union__sdma_registers_h_413._anonymous_ = ('_0',)
union__sdma_registers_h_413._fields_ = [
    ('_0', struct__sdma_registers_h_414),
    ('DW_3_DATA', ctypes.c_uint32),
]

class union__sdma_registers_h_420(Union):
    pass

class struct__sdma_registers_h_421(Structure):
    pass

struct__sdma_registers_h_421._pack_ = 1 # source:False
struct__sdma_registers_h_421._fields_ = [
    ('src_data_63_32', ctypes.c_uint32, 32),
]

union__sdma_registers_h_420._pack_ = 1 # source:False
union__sdma_registers_h_420._anonymous_ = ('_0',)
union__sdma_registers_h_420._fields_ = [
    ('_0', struct__sdma_registers_h_421),
    ('DW_4_DATA', ctypes.c_uint32),
]

class union__sdma_registers_h_427(Union):
    pass

class struct__sdma_registers_h_428(Structure):
    pass

struct__sdma_registers_h_428._pack_ = 1 # source:False
struct__sdma_registers_h_428._fields_ = [
    ('cmp_data_31_0', ctypes.c_uint32, 32),
]

union__sdma_registers_h_427._pack_ = 1 # source:False
union__sdma_registers_h_427._anonymous_ = ('_0',)
union__sdma_registers_h_427._fields_ = [
    ('_0', struct__sdma_registers_h_428),
    ('DW_5_DATA', ctypes.c_uint32),
]

class union__sdma_registers_h_434(Union):
    pass

class struct__sdma_registers_h_435(Structure):
    pass

struct__sdma_registers_h_435._pack_ = 1 # source:False
struct__sdma_registers_h_435._fields_ = [
    ('cmp_data_63_32', ctypes.c_uint32, 32),
]

union__sdma_registers_h_434._pack_ = 1 # source:False
union__sdma_registers_h_434._anonymous_ = ('_0',)
union__sdma_registers_h_434._fields_ = [
    ('_0', struct__sdma_registers_h_435),
    ('DW_6_DATA', ctypes.c_uint32),
]

class union__sdma_registers_h_441(Union):
    pass

class struct__sdma_registers_h_442(Structure):
    pass

struct__sdma_registers_h_442._pack_ = 1 # source:False
struct__sdma_registers_h_442._fields_ = [
    ('loop_interval', ctypes.c_uint32, 13),
    ('reserved_0', ctypes.c_uint32, 19),
]

union__sdma_registers_h_441._pack_ = 1 # source:False
union__sdma_registers_h_441._anonymous_ = ('_0',)
union__sdma_registers_h_441._fields_ = [
    ('_0', struct__sdma_registers_h_442),
    ('DW_7_DATA', ctypes.c_uint32),
]

struct_SDMA_PKT_ATOMIC_TAG._pack_ = 1 # source:False
struct_SDMA_PKT_ATOMIC_TAG._fields_ = [
    ('HEADER_UNION', union__sdma_registers_h_388),
    ('ADDR_LO_UNION', union__sdma_registers_h_399),
    ('ADDR_HI_UNION', union__sdma_registers_h_406),
    ('SRC_DATA_LO_UNION', union__sdma_registers_h_413),
    ('SRC_DATA_HI_UNION', union__sdma_registers_h_420),
    ('CMP_DATA_LO_UNION', union__sdma_registers_h_427),
    ('CMP_DATA_HI_UNION', union__sdma_registers_h_434),
    ('LOOP_UNION', union__sdma_registers_h_441),
]
...
class union__sdma_registers_h_451(Union):
    pass

class struct__sdma_registers_h_452(Structure):
    pass

struct__sdma_registers_h_452._pack_ = 1 # source:False
struct__sdma_registers_h_452._fields_ = [
    ('op', ctypes.c_uint32, 8),
    ('sub_op', ctypes.c_uint32, 8),
    ('reserved_0', ctypes.c_uint32, 16),
]

union__sdma_registers_h_451._pack_ = 1 # source:False
union__sdma_registers_h_451._anonymous_ = ('_0',)
union__sdma_registers_h_451._fields_ = [
    ('_0', struct__sdma_registers_h_452),
    ('DW_0_DATA', ctypes.c_uint32),
]

class union__sdma_registers_h_460(Union):
    pass

class struct__sdma_registers_h_461(Structure):
    pass

struct__sdma_registers_h_461._pack_ = 1 # source:False
struct__sdma_registers_h_461._fields_ = [
    ('addr_31_0', ctypes.c_uint32, 32),
]

union__sdma_registers_h_460._pack_ = 1 # source:False
union__sdma_registers_h_460._anonymous_ = ('_0',)
union__sdma_registers_h_460._fields_ = [
    ('_0', struct__sdma_registers_h_461),
    ('DW_1_DATA', ctypes.c_uint32),
]

class union__sdma_registers_h_467(Union):
    pass

class struct__sdma_registers_h_468(Structure):
    pass

struct__sdma_registers_h_468._pack_ = 1 # source:False
struct__sdma_registers_h_468._fields_ = [
    ('addr_63_32', ctypes.c_uint32, 32),
]

union__sdma_registers_h_467._pack_ = 1 # source:False
union__sdma_registers_h_467._anonymous_ = ('_0',)
union__sdma_registers_h_467._fields_ = [
    ('_0', struct__sdma_registers_h_468),
    ('DW_2_DATA', ctypes.c_uint32),
]

struct_SDMA_PKT_TIMESTAMP_TAG._pack_ = 1 # source:False
struct_SDMA_PKT_TIMESTAMP_TAG._fields_ = [
    ('HEADER_UNION', union__sdma_registers_h_451),
    ('ADDR_LO_UNION', union__sdma_registers_h_460),
    ('ADDR_HI_UNION', union__sdma_registers_h_467),
]
...
class union__sdma_registers_h_477(Union):
    pass

class struct__sdma_registers_h_478(Structure):
    pass

struct__sdma_registers_h_478._pack_ = 1 # source:False
struct__sdma_registers_h_478._fields_ = [
    ('op', ctypes.c_uint32, 8),
    ('sub_op', ctypes.c_uint32, 8),
    ('reserved_0', ctypes.c_uint32, 16),
]

union__sdma_registers_h_477._pack_ = 1 # source:False
union__sdma_registers_h_477._anonymous_ = ('_0',)
union__sdma_registers_h_477._fields_ = [
    ('_0', struct__sdma_registers_h_478),
    ('DW_0_DATA', ctypes.c_uint32),
]

class union__sdma_registers_h_486(Union):
    pass

class struct__sdma_registers_h_487(Structure):
    pass

struct__sdma_registers_h_487._pack_ = 1 # source:False
struct__sdma_registers_h_487._fields_ = [
    ('int_ctx', ctypes.c_uint32, 28),
    ('reserved_1', ctypes.c_uint32, 4),
]

union__sdma_registers_h_486._pack_ = 1 # source:False
union__sdma_registers_h_486._anonymous_ = ('_0',)
union__sdma_registers_h_486._fields_ = [
    ('_0', struct__sdma_registers_h_487),
    ('DW_1_DATA', ctypes.c_uint32),
]

struct_SDMA_PKT_TRAP_TAG._pack_ = 1 # source:False
struct_SDMA_PKT_TRAP_TAG._fields_ = [
    ('HEADER_UNION', union__sdma_registers_h_477),
    ('INT_CONTEXT_UNION', union__sdma_registers_h_486),
]
...
class union__sdma_registers_h_510(Union):
    pass

class struct__sdma_registers_h_511(Structure):
    pass

struct__sdma_registers_h_511._pack_ = 1 # source:False
struct__sdma_registers_h_511._fields_ = [
    ('op', ctypes.c_uint32, 8),
    ('sub_op', ctypes.c_uint32, 8),
    ('_2', ctypes.c_uint32, 16),
]

union__sdma_registers_h_510._pack_ = 1 # source:False
union__sdma_registers_h_510._anonymous_ = ('_0',)
union__sdma_registers_h_510._fields_ = [
    ('_0', struct__sdma_registers_h_511),
    ('DW_0_DATA', ctypes.c_uint32),
]

class union__sdma_registers_h_519(Union):
    pass

class struct__sdma_registers_h_520(Structure):
    pass

struct__sdma_registers_h_520._pack_ = 1 # source:False
struct__sdma_registers_h_520._fields_ = [
    ('_0', ctypes.c_uint32, 7),
    ('BaseVA_LO', ctypes.c_uint32, 25),
]

union__sdma_registers_h_519._pack_ = 1 # source:False
union__sdma_registers_h_519._anonymous_ = ('_0',)
union__sdma_registers_h_519._fields_ = [
    ('_0', struct__sdma_registers_h_520),
    ('DW_1_DATA', ctypes.c_uint32),
]

class union__sdma_registers_h_527(Union):
    pass

class struct__sdma_registers_h_528(Structure):
    pass

struct__sdma_registers_h_528._pack_ = 1 # source:False
struct__sdma_registers_h_528._fields_ = [
...
union__sdma_registers_h_527._pack_ = 1 # source:False
union__sdma_registers_h_527._anonymous_ = ('_0',)
union__sdma_registers_h_527._fields_ = [
    ('_0', struct__sdma_registers_h_528),
    ('DW_2_DATA', ctypes.c_uint32),
]

class union__sdma_registers_h_547(Union):
    pass

class struct__sdma_registers_h_548(Structure):
    pass

struct__sdma_registers_h_548._pack_ = 1 # source:False
struct__sdma_registers_h_548._fields_ = [
...
union__sdma_registers_h_547._pack_ = 1 # source:False
union__sdma_registers_h_547._anonymous_ = ('_0',)
union__sdma_registers_h_547._fields_ = [
    ('_0', struct__sdma_registers_h_548),
    ('DW_3_DATA', ctypes.c_uint32),
]

class union__sdma_registers_h_557(Union):
    pass

class struct__sdma_registers_h_558(Structure):
    pass

struct__sdma_registers_h_558._pack_ = 1 # source:False
struct__sdma_registers_h_558._fields_ = [
...
union__sdma_registers_h_557._pack_ = 1 # source:False
union__sdma_registers_h_557._anonymous_ = ('_0',)
union__sdma_registers_h_557._fields_ = [
    ('_0', struct__sdma_registers_h_558),
    ('DW_4_DATA', ctypes.c_uint32),
]

struct_SDMA_PKT_GCR_TAG._pack_ = 1 # source:False
struct_SDMA_PKT_GCR_TAG._fields_ = [
    ('HEADER_UNION', union__sdma_registers_h_510),
    ('WORD1_UNION', union__sdma_registers_h_519),
    ('WORD2_UNION', union__sdma_registers_h_527),
    ('WORD3_UNION', union__sdma_registers_h_547),
    ('WORD4_UNION', union__sdma_registers_h_557),
]
...
__all__ = \
    ...
    'HsaVersionInfo', 'MAX_HSA_DEVICE', 'SDMA_ATOMIC_ADD64',
    'SDMA_OP_ATOMIC', 'SDMA_OP_CONST_FILL', 'SDMA_OP_COPY',
    'SDMA_OP_FENCE', 'SDMA_OP_GCR', 'SDMA_OP_POLL_REGMEM',
    'SDMA_OP_TIMESTAMP', 'SDMA_OP_TRAP', 'SDMA_PKT_ATOMIC',
    'SDMA_PKT_CONSTANT_FILL', 'SDMA_PKT_COPY_LINEAR',
    'SDMA_PKT_COPY_LINEAR_RECT', 'SDMA_PKT_FENCE', 'SDMA_PKT_GCR',
    'SDMA_PKT_HDP_FLUSH', 'SDMA_PKT_POLL_REGMEM',
    'SDMA_PKT_TIMESTAMP', 'SDMA_PKT_TRAP', 'SDMA_SUBOP_COPY_LINEAR',
    'SDMA_SUBOP_COPY_LINEAR_RECT', 'SDMA_SUBOP_TIMESTAMP_GET_GLOBAL',
    'SDMA_SUBOP_USER_GCR', '_HSAKMT_STATUS', '_HSA_CACHING_TYPE',
    '_HSA_DBG_TRAP_EXCEPTION_CODE', '_HSA_DBG_TRAP_MASK',
    '_HSA_DBG_TRAP_OVERRIDE', '_HSA_DBG_WATCH_MODE',
    '_HSA_DBG_WAVEMODE', '_HSA_DBG_WAVEMSG_TYPE', '_HSA_DBG_WAVEOP',
    ...
    'hdp_flush_cmd', 'hsaKmtAcquireSystemProperties',
    'hsaKmtAllocMemory', 'hsaKmtAllocQueueGWS',
    'hsaKmtAvailableMemory', 'hsaKmtCheckRuntimeDebugSupport',
    'hsaKmtCloseKFD', 'hsaKmtCreateEvent', 'hsaKmtCreateQueue',
    'hsaKmtDbgAddressWatch', 'hsaKmtDbgDisable', 'hsaKmtDbgEnable',
    'hsaKmtDbgGetDeviceData', 'hsaKmtDbgGetQueueData',
    'hsaKmtDbgRegister', 'hsaKmtDbgUnregister',
    'hsaKmtDbgWavefrontControl', 'hsaKmtDebugTrapIoctl',
    'hsaKmtDeregisterMemory', 'hsaKmtDestroyEvent',
    'hsaKmtDestroyQueue', 'hsaKmtExportDMABufHandle',
    'hsaKmtFreeMemory', 'hsaKmtGetAMDGPUDeviceHandle',
    'hsaKmtGetClockCounters', 'hsaKmtGetNodeCacheProperties',
    'hsaKmtGetNodeIoLinkProperties', 'hsaKmtGetNodeMemoryProperties',
    'hsaKmtGetNodeProperties', 'hsaKmtGetQueueInfo',
    'hsaKmtGetRuntimeCapabilities', 'hsaKmtGetTileConfig',
    'hsaKmtGetVersion', 'hsaKmtGetXNACKMode',
    ...
    'struct_SDMA_PKT_ATOMIC_TAG', 'struct_SDMA_PKT_CONSTANT_FILL_TAG',
    'struct_SDMA_PKT_COPY_LINEAR_RECT_TAG',
    'struct_SDMA_PKT_COPY_LINEAR_TAG', 'struct_SDMA_PKT_FENCE_TAG',
    'struct_SDMA_PKT_GCR_TAG', 'struct_SDMA_PKT_HDP_FLUSH_TAG',
    'struct_SDMA_PKT_POLL_REGMEM_TAG',
    'struct_SDMA_PKT_TIMESTAMP_TAG', 'struct_SDMA_PKT_TRAP_TAG',
    ...
    'struct__hsakmttypes_h_1279', 'struct__hsakmttypes_h_165',
    'struct__hsakmttypes_h_177', 'struct__hsakmttypes_h_188',
    'struct__hsakmttypes_h_229', 'struct__hsakmttypes_h_359',
    'struct__hsakmttypes_h_380', 'struct__hsakmttypes_h_407',
    'struct__hsakmttypes_h_474', 'struct__hsakmttypes_h_516',
    'struct__hsakmttypes_h_581', 'struct__sdma_registers_h_106',
    'struct__sdma_registers_h_113', 'struct__sdma_registers_h_120',
    'struct__sdma_registers_h_137', 'struct__sdma_registers_h_147',
    'struct__sdma_registers_h_154', 'struct__sdma_registers_h_161',
    'struct__sdma_registers_h_171', 'struct__sdma_registers_h_180',
    'struct__sdma_registers_h_188', 'struct__sdma_registers_h_195',
    'struct__sdma_registers_h_202', 'struct__sdma_registers_h_212',
    'struct__sdma_registers_h_221', 'struct__sdma_registers_h_229',
    'struct__sdma_registers_h_239', 'struct__sdma_registers_h_254',
    'struct__sdma_registers_h_265', 'struct__sdma_registers_h_272',
    'struct__sdma_registers_h_279', 'struct__sdma_registers_h_286',
    'struct__sdma_registers_h_298', 'struct__sdma_registers_h_314',
    'struct__sdma_registers_h_321', 'struct__sdma_registers_h_328',
    'struct__sdma_registers_h_337', 'struct__sdma_registers_h_350',
    'struct__sdma_registers_h_357', 'struct__sdma_registers_h_364',
    'struct__sdma_registers_h_371', 'struct__sdma_registers_h_378',
    'struct__sdma_registers_h_389', 'struct__sdma_registers_h_400',
    'struct__sdma_registers_h_407', 'struct__sdma_registers_h_414',
    'struct__sdma_registers_h_421', 'struct__sdma_registers_h_428',
    'struct__sdma_registers_h_435', 'struct__sdma_registers_h_442',
    'struct__sdma_registers_h_452', 'struct__sdma_registers_h_461',
    'struct__sdma_registers_h_468', 'struct__sdma_registers_h_478',
    'struct__sdma_registers_h_487', 'struct__sdma_registers_h_511',
    'struct__sdma_registers_h_520', 'struct__sdma_registers_h_528',
    'struct__sdma_registers_h_548', 'struct__sdma_registers_h_558',
    'struct__sdma_registers_h_71', 'struct__sdma_registers_h_80',
    'struct__sdma_registers_h_88', 'struct__sdma_registers_h_99',
    'struct_kfd_ioctl_dbg_trap_args', 'union_HSA_CAPABILITY',
    ...
    'union__HsaDbgWaveMessageAMD', 'union__hsakmttypes_h_1066',
    'union__hsakmttypes_h_1277', 'union__hsakmttypes_h_377',
    'union__hsakmttypes_h_514', 'union__hsakmttypes_h_579',
    'union__hsakmttypes_h_743', 'union__hsakmttypes_h_751',
    'union__hsakmttypes_h_759', 'union__hsakmttypes_h_972',
    'union__sdma_registers_h_105', 'union__sdma_registers_h_112',
    'union__sdma_registers_h_119', 'union__sdma_registers_h_136',
    'union__sdma_registers_h_146', 'union__sdma_registers_h_153',
    'union__sdma_registers_h_160', 'union__sdma_registers_h_170',
    'union__sdma_registers_h_179', 'union__sdma_registers_h_187',
    'union__sdma_registers_h_194', 'union__sdma_registers_h_201',
    'union__sdma_registers_h_211', 'union__sdma_registers_h_220',
    'union__sdma_registers_h_228', 'union__sdma_registers_h_238',
    'union__sdma_registers_h_253', 'union__sdma_registers_h_264',
    'union__sdma_registers_h_271', 'union__sdma_registers_h_278',
    'union__sdma_registers_h_285', 'union__sdma_registers_h_297',
    'union__sdma_registers_h_313', 'union__sdma_registers_h_320',
    'union__sdma_registers_h_327', 'union__sdma_registers_h_336',
    'union__sdma_registers_h_349', 'union__sdma_registers_h_356',
    'union__sdma_registers_h_363', 'union__sdma_registers_h_370',
    'union__sdma_registers_h_377', 'union__sdma_registers_h_388',
    'union__sdma_registers_h_399', 'union__sdma_registers_h_406',
    'union__sdma_registers_h_413', 'union__sdma_registers_h_420',
    'union__sdma_registers_h_427', 'union__sdma_registers_h_434',
    'union__sdma_registers_h_441', 'union__sdma_registers_h_451',
    'union__sdma_registers_h_460', 'union__sdma_registers_h_467',
    'union__sdma_registers_h_477', 'union__sdma_registers_h_486',
    'union__sdma_registers_h_510', 'union__sdma_registers_h_519',
    'union__sdma_registers_h_527', 'union__sdma_registers_h_547',
    'union__sdma_registers_h_557', 'union__sdma_registers_h_70',
    'union__sdma_registers_h_79', 'union__sdma_registers_h_87',
    'union__sdma_registers_h_98']
