...
class HWQueue:
  ...
  def submit_barrier(self, wait_signals=None, need_signal=False, header=BARRIER_HEADER):
  ...
  def submit_copy(self, dest, src, size, wait_signals=None, need_signal=False, kernargs=None):
    ...
    # assert ctypes.sizeof(CopyAligned) == 84
    ...
    # print(hex(copy_st.phase1_src_start))
    # print(hex(copy_st.phase1_dst_start))
    # print(hex(copy_st.phase2_src_start))
    # print(hex(copy_st.phase2_dst_start))
    # print(hex(copy_st.phase3_src_start))
    # print(hex(copy_st.phase3_dst_start))
    # print(hex(copy_st.phase4_src_start))
    # print(hex(copy_st.phase4_dst_start))
    # print(hex(copy_st.phase4_src_end))
    # print(hex(copy_st.phase4_dst_end))
    # print(hex(copy_st.num_workitems))
    ...
    # print(hex(self.device.copy_kern_object))
    ...
    return signal
    # return self.submit_kernel(wait_signals, prg, global_size, local_size, kernargs, need_signal=need_signal)
